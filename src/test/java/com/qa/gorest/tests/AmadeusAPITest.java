...
public class AmadeusAPITest extends BaseTest{
	...
	public void flightAPiSetup(String baseURI, String grantType, String clientId, String clientSecret) {
		...
		accessToken = restClient.getAccessToken(AMADES_TOKEN_ENDPOINT, grantType, clientId, clientSecret);
	}
	...
	public void getFlightInfoTest() {
		...
		Response flightDataResponse = restClientFlight.get(AMADES_FLIGHTBOOKING_ENDPOINT, queryParams, headersMap, false, true)
							.then().log().all()
							.assertThat()
		...
		System.out.println(type);//flight-destination
		 ...
		 System.out.println(flightDataResponse.prettyPrint());
